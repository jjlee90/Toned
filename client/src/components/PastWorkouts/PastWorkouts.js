  ...
  useEffect(() => {
    ...
    const fetchSquat = async () => {
      const response = await fetch(
        `${process.env.REACT_APP_SERVER_URL}exercise/${username}/specific/Squat`,
        {
          method: "GET",
          headers: {
    ...
    const fetchBenchPress = async () => {
      const response = await fetch(
        `${process.env.REACT_APP_SERVER_URL}exercise/${username}/specific/Bench Press`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
    ...
    const fetchInclineBenchPress = async () => {
      const response = await fetch(
        `${process.env.REACT_APP_SERVER_URL}exercise/${username}/specific/Incline Bench Press`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
    ...
    const fetchDeclineBenchPress = async () => {
      const response = await fetch(
        `${process.env.REACT_APP_SERVER_URL}exercise/${username}/specific/Decline Bench Press`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
    ...
    const fetchLegPress = async () => {
      const response = await fetch(
        `${process.env.REACT_APP_SERVER_URL}exercise/${username}/specific/Leg Press`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
    ...
    const fetchRomanianDeadlift = async () => {
      const response = await fetch(
        `${process.env.REACT_APP_SERVER_URL}exercise/${username}/specific/Romanian Deadlift`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
    ...
    const fetchDeadlift = async () => {
      const response = await fetch(
        `${process.env.REACT_APP_SERVER_URL}exercise/${username}/specific/Deadlift`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
    ...
    const fetchLatPulldown = async () => {
      const response = await fetch(
        `${process.env.REACT_APP_SERVER_URL}exercise/${username}/specific/Lat Pulldown`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
    ...
    const fetchPullUps = async () => {
      const response = await fetch(
        `${process.env.REACT_APP_SERVER_URL}exercise/${username}/specific/Pull-Ups`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
    ...
    const fetchPushUps = async () => {
      const response = await fetch(
        `${process.env.REACT_APP_SERVER_URL}exercise/${username}/specific/Push-Ups`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
